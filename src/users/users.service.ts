...
export class UsersService {
  ...
  async register(
    ...
    try {
      ...
      delete user.pwdHash;
      // Mail powitalny jest efektem ubocznym, nie warunkiem udanej rejestracji — błąd SMTP
      // (np. jeszcze nieuzupełniona konfiguracja) nie może wywalać konta użytkownikowi.
      try {
